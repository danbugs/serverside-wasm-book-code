...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "storygen"]
    unsafe extern "C" fn export_storygen() -> *mut u8 {
      $($path_to_types)*::_export_storygen_cabi::<$ty>()
    }
    #[export_name = "cabi_post_storygen"]
    unsafe extern "C" fn _post_return_storygen(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_storygen::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
